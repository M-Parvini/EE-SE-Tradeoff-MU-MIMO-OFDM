function SE = KhalidRCD(H_total, Chan, OFDM, BS, UE, Atfc, Arfc, gains)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Start of algorithm
% find the inidces that result in highest sum channel gain
for u=1:U
    [val,indices]=maxk(abs(gains(:,u)),Nr_rf);
    WRF(:,:,u) = Arfc(:,indices,u);
